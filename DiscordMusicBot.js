...
class DiscordMusicBot extends Client {
  ...
  constructor(
    ...
    this.function = require('../functions/index.js');
  }
  ...
  build() {
    ...
    this.manager = new Manager({
      ...
      retryDelay: this.config.nodes.retryDelay,
      retryAmount: this.config.nodes.retryAmount,
      autoPlay: this.config.alwaysplay,
      clientName: `${require("../package.json").name}/v${require("../package.json").version} (Bot: ${
